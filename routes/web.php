...
Route::middleware(['web', 'auth', 'verified'])->prefix('customer')->group(function () {
    Route::get('/dashboard', Dashboard::class)->name('customer.dashboard');
    Route::get('/wishlist', Wishlists::class)->name('customer.wishlist');
    Route::get('/addresses', Addresses::class)->name('customer.addresses');
    Route::get('/addresses/form/{id?}', Form::class)->name('customer.addresses.form');
    Route::get('/orders', Orders::class)->name('customer.orders');
    Route::get('/orders/{id}', OrderDetails::class)->name('customer.orders.detail');
    Route::get('/reviews/edit/{productId?}', Reviews::class)->name('customer.reviews');
});
